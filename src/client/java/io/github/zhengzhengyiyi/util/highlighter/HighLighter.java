...
public interface HighLighter {
     ...
     */
    void drawHighlightedText(GuiGraphicsExtractor context, Font font, String text, int x, int y, boolean editable);
    
    /**
     * Calculates the total width of the syntax-highlighted text.
     * 
     * @param font the font for measuring text width
     * @param text the text to be measured
     * @return the total width in pixels of the highlighted text
     */
    int getTextWidth(Font font, String text);
     ...
     */
    int getCharIndexFromTokens(Font font, String line, int targetX);
     ...
     */
    int getTextWidthUpToChar(Font font, String line, int charIndex);
}
